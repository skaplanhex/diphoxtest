...
cc  correction factor is given in MRST.
      ...
      call mrst2001(xcc,scale,mode,upv,dnv,usea,dsea,str,chm,bot,glu)
   ...
   21 CONTINUE
      ...
      call mrst2001(xccu,scale,mode,upv,dnv,usea,dsea,str,chm,bot,glu)
      if(epsc.gt.1.) chm=0.
      f2wppxu= 2.*chm
      f3wppxu=-2.*chm
      f2wmpxu= 2.*chm
      f3wmpxu= 2.*chm
      xccl=xcc*(1.-0.5*del)
      call mrst2001(xccl,scale,mode,upv,dnv,usea,dsea,str,chm,bot,glu)
      if(epsc.gt.1.) chm=0.
      f2wppxl= 2.*chm
      f3wppxl=-2.*chm
      f2wmpxl= 2.*chm
...
c  computes contribution proportional to Vcb**2
      ...
      call mrst2001(xbb,scale,mode,upv,dnv,usea,dsea,str,chm,bot,glu)
      if(epsc.gt.1.) chm=0.
      bf2wpp= 2.*chm
      bf3wpp=-2.*chm
      bf2wmp= 2.*chm
      ...
      call mrst2001(xbbu,scale,mode,upv,dnv,usea,dsea,str,chm,bot,glu)
      if(epsb.gt.1.) bot=0.
      f2wppxu= 2.*bot
      f3wppxu= 2.*bot
      f2wmpxu= 2.*bot
      f3wmpxu=-2.*bot
      xbbl=xbb*(1.-0.5*del)
      call mrst2001(xbbl,scale,mode,upv,dnv,usea,dsea,str,chm,bot,glu)
      if(epsb.gt.1.) bot=0.
      f2wppxl= 2.*bot
      f3wppxl= 2.*bot
      f2wmpxl= 2.*bot
